...
def kmeans_eval_set(n,size,profile_features,labels,modlist):
  kmeans = KMeans(n_clusters=int(size*len(labels)), random_state=n).fit(profile_features)
...
def run_trial(profile_features,labels,modlist,this_train_sizes,results,val_results,n):
  ...
  eval_set = kmeans_eval_set(n,0.1,profile_features,labels,modlist)
...
json.dump(avg_results.tolist(),open("avg_kmeansdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(min_results.tolist(),open("min_kmeansdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(max_results.tolist(),open("max_kmeansdatalimit10_boostrapped_predmae_100sim.json","w"))

json.dump(avg_val_results.tolist(),open("avg_val_kmeansdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(min_val_results.tolist(),open("min_val_kmeansdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(max_val_results.tolist(),open("max_val_kmeansdatalimit10_boostrapped_predmae_100sim.json","w"))


json.dump(this_train_sizes.tolist(),open("trainsize_kmeansdatalimit10_bootstrapped_predmae_100sim.json","w"))
