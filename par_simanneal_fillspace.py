...
json.dump(ret_results.tolist(),open("simanneal_fillspace_1000000sim.json","w"))
json.dump(this_train_sizes.tolist(),open("trainsize_simanneal_fillspace_1000000sim.json","w"))
