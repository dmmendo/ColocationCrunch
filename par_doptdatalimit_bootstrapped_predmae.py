...
def dopt_eval_set(num_trials,size,profile_features,labels,modlist):
...
def run_trial(profile_features,labels,modlist,this_train_sizes,results,val_results,n):
  ...
  eval_set = dopt_eval_set(1000000,0.1,profile_features,labels,modlist)
...
json.dump(avg_results.tolist(),open("avg_doptdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(min_results.tolist(),open("min_doptdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(max_results.tolist(),open("max_doptdatalimit10_boostrapped_predmae_100sim.json","w"))

json.dump(avg_val_results.tolist(),open("avg_val_doptdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(min_val_results.tolist(),open("min_val_doptdatalimit10_boostrapped_predmae_100sim.json","w"))
json.dump(max_val_results.tolist(),open("max_val_doptdatalimit10_boostrapped_predmae_100sim.json","w"))


json.dump(this_train_sizes.tolist(),open("trainsize_doptdatalimit10_bootstrapped_predmae_100sim.json","w"))
