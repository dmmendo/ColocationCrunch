...
def run_trial(profile_features,labels,modlist,this_train_sizes,results,n):
  ...
  for i in range(1,len(this_train_sizes)):
    ...
    eval_set_size = int(len(labels)/2)
...
json.dump(results.tolist(),open("datalimit_predmae_10sim.json","w"))
json.dump(this_train_sizes.tolist(),open("trainsize_datalimit_predmae_10sim.json","w"))
